...
from library import sdxl_model_util, train_util, sdxl_original_unet
...
def _load_target_model(
    name_or_path: str, vae_path: Optional[str], model_version: str, weight_dtype, model_dtype=None
):
